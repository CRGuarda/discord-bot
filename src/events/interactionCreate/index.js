...
import { hasPreferredRole, isCooldown, validateInteraction } from './helpers/indexHelpers.js'
...
export default async (interaction) => {
  ...
  const preferredRole = await hasPreferredRole(interaction)
  if (!preferredRole) return interaction.reply(`Can't mention outside preferred role (Los Timos).`)
